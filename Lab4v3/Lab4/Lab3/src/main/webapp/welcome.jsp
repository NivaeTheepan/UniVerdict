    ...
    <body>
      ...
      <a href="welcome.jsp">
        ...
        <div class="user-hero">
            ...
            <p class="user-p2">To access the Resources page of UniVerdict - <a class="btn btn-with-bg" href="addResources.html">Resources</a> </p>
            <p class="user-p2">To access the Courses page of UniVerdict - <a class="btn btn-with-bg" href="addCourses.html">Courses</a> </p>
