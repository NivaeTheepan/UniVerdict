...
public class Authenticate 
{
    ...
    public Authenticate() 
    {
        sigAlgo = SignatureAlgorithm.HS256;
        secretString = Encoders.BASE64.encode("secureCodeThatIsSuperDuperSecureSoNobodyCanGuessIt".getBytes());
    }
...
//            System.out.println(" we *cannot* use the JWT as intended by its creator");
       ...
       return new  AbstractMap.SimpleEntry<Boolean, String>(true,username);
    }
}
